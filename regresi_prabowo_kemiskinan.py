...
my_dict = {'value1':prabowo}

# Create Dataframe
df = pd.DataFrame(my_dict)

#import file CSV
df1 = pd.read_csv('D:\kuliah S2 ITS\semester 1\Manajemen Data dan Informasi\UAS\kemiskinan.csv')
...
plt.title('Prabowo dan Peluang Dukungan Dari Penduduk Miskin (Training set)')
plt.xlabel('Suara Prabowo')
